...
public class HttpHelper {
    ...
    public static void downloadLocalFile(String localFilePath, String exportFileName, HttpServletResponse response) throws Exception {
        downloadFile(new File(localFilePath), exportFileName, response);
    }
     ...
     * @throws Exception
     */
    public static void downloadFile(File file, String exportFileName, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            log.error("下载导出文件失败:" + file.getAbsolutePath(), e);
        } finally {
            if (bis != null) {
                bis.close();
            }
