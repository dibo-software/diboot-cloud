...
public class SystemTemplateVariableServiceImpl implements TemplateVariableService {
    ...
    @Override
    public String parseTemplate2Content(String templateContent, VariableData variableData) throws Exception {
        // 提取模版中使用到的模版变量
        ...
        for (String variable : messageTemplateVariables) {
            ...
            // 执行方法，获取变量值
            Object value = method.invoke(this, variableData);
            if (value != null) {
    ...
    private String getRealName(VariableData variableData) {
        return V.notEmpty(variableData.getRealName()) ? variableData.getRealName() : "";
    }
    ...
    private String getMobilePhone(VariableData variableData) {
        return V.notEmpty(variableData.getPhone()) ? variableData.getPhone() : "";
    }
}
