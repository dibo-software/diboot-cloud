...
execute sp_addextendedproperty 'MS_Description', N'创建人ID', 'SCHEMA', '${SCHEMA}', 'table', schedule_job, 'column', 'create_by';
execute sp_addextendedproperty 'MS_Description', N'创建人', 'SCHEMA', '${SCHEMA}', 'table', schedule_job, 'column', 'create_by_name';
...
execute sp_addextendedproperty 'MS_Description', N'创建人ID', 'SCHEMA', '${SCHEMA}', 'table', schedule_job_log, 'column', 'create_by';
execute sp_addextendedproperty 'MS_Description', N'创建人', 'SCHEMA', '${SCHEMA}', 'table', schedule_job_log, 'column', 'create_by_name';
