 ...
 */
@ControllerAdvice
public class ExampleExceptionHandler extends DefaultExceptionHandler {
    private final static Logger log = LoggerFactory.getLogger(ExampleExceptionHandler.class);
